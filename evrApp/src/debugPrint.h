...
|*      DEBUGPRINT (DB_XXX, InterestFlag, (printfArgs));
...
|*      DB_XXX          = Message severity.  The six defined levels, in order of increasing
...
|*                        The debug message will be printed if the message severity code (DB_XXXX)
